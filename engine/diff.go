...
// DiffEngineImpl computes diffs between desired and live Kubernetes resources.
type DiffEngineImpl struct {
	DynClient *dynamic.DynamicClient
	Discovery discovery.DiscoveryInterface
}

// NewDiffEngine creates a new DiffEngineImpl with the given dynamic client and discovery interface.
func NewDiffEngine(dynClient *dynamic.DynamicClient, discovery discovery.DiscoveryInterface) *DiffEngineImpl {
...
func (d *DiffEngineImpl) fetchLiveResources(ctx context.Context, namespace string) (map[string]unstructured.Unstructured, error) {
...
func resourceEqual(a, b unstructured.Unstructured) bool {
	...
	aMeta, _, _ := unstructured.NestedMap(a.Object, "metadata")
	bMeta, _, _ := unstructured.NestedMap(b.Object, "metadata")
