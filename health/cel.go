...
// EvaluatorImpl evaluates CEL expressions for health checks.
type EvaluatorImpl struct {
	httpClient *http.Client
}

// NewEvaluator creates a new CEL health evaluator.
func NewEvaluator() *EvaluatorImpl {
...
func (e *EvaluatorImpl) Evaluate(ctx context.Context, check paprikav1.HealthCheck, app *paprikav1.Application) EvalResult {
...
func (e *EvaluatorImpl) doHTTPProbe(ctx context.Context, probe *paprikav1.HTTPProbe) *HTTPResult {
...
func (e *EvaluatorImpl) evalExpression(expr string, app *paprikav1.Application, httpResult *HTTPResult) (status paprikav1.HealthStatus, message string) {
	env, err := cel.NewEnv(
