...
// ResourceHealthCheckerImpl implements ResourceHealthChecker for Kubernetes resources.
type ResourceHealthCheckerImpl struct {
	client.Client
}

// NewResourceHealthChecker creates a new resource health checker.
func NewResourceHealthChecker(c client.Client) *ResourceHealthCheckerImpl {
	return &ResourceHealthCheckerImpl{Client: c}
}

// Check evaluates the health of a resource by kind.
func (r *ResourceHealthCheckerImpl) Check(ctx context.Context, kind, name, namespace string) paprikav1.ResourceHealth {
	switch kind {
	case "Deployment":
...
func (r *ResourceHealthCheckerImpl) checkDeployment(ctx context.Context, name, namespace string) paprikav1.ResourceHealth {
...
func (r *ResourceHealthCheckerImpl) checkService(ctx context.Context, name, namespace string) paprikav1.ResourceHealth {
...
func (r *ResourceHealthCheckerImpl) checkIngress(ctx context.Context, name, namespace string) paprikav1.ResourceHealth {
