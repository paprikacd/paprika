...
// ListApplicationSets is not implemented by the repo server.
func (s *Server) ListApplicationSets(ctx context.Context, req *connect.Request[paprikav1.ListApplicationSetsRequest]) (*connect.Response[paprikav1.ListApplicationSetsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("repo server does not implement ListApplicationSets"))
}

// GetApplicationSet is not implemented by the repo server.
...
// GetResourceLogs is not implemented by the repo server.
func (s *Server) GetResourceLogs(ctx context.Context, _ *connect.Request[paprikav1.GetResourceLogsRequest]) (*connect.Response[paprikav1.GetResourceLogsResponse], error) {
	log.FromContext(ctx).Info("GetResourceLogs not implemented on repo server")
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("repo server does not implement GetResourceLogs"))
}

// GetResourceTreeDetailed is not implemented by the repo server.
func (s *Server) GetResourceTreeDetailed(ctx context.Context, _ *connect.Request[paprikav1.GetResourceTreeDetailedRequest]) (*connect.Response[paprikav1.GetResourceTreeDetailedResponse], error) {
	log.FromContext(ctx).Info("GetResourceTreeDetailed not implemented on repo server")
...
func (s *Server) GetArtifact(ctx context.Context, _ *connect.Request[paprikav1.GetArtifactRequest]) (*connect.Response[paprikav1.GetArtifactResponse], error) {
	...
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("repo server does not implement GetArtifact"))
}

// ListArtifacts is not implemented by the repo server.
func (s *Server) ListArtifacts(ctx context.Context, _ *connect.Request[paprikav1.ListArtifactsRequest]) (*connect.Response[paprikav1.ListArtifactsResponse], error) {
	log.FromContext(ctx).Info("ListArtifacts not implemented on repo server")
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("repo server does not implement ListArtifacts"))
}
