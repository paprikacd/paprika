...
func newReleasesCmd(ctx context.Context, clientFn func() (v1connect.PaprikaServiceClient, error), nsFn func() string, output *string) *cobra.Command {
	cmd := &cobra.Command{
		Use:   "releases",
	...
	cmd.AddCommand(&cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			res, err := client.ListReleases(ctx, connect.NewRequest(&paprikav1.ListReleasesRequest{
