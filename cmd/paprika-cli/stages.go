...
func newStagesCmd(clientFn func() (v1connect.PaprikaServiceClient, error), nsFn func() string, output *string) *cobra.Command {
	cmd := &cobra.Command{
		Use:   "stages",
		Short: "Manage stages",
	}
	...
	cmd.AddCommand(&cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			res, err := client.ListStages(context.Background(), connect.NewRequest(&paprikav1.ListStagesRequest{
